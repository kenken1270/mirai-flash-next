...
function StudyContent() {
  ...
  const [lang1Label, setLang1Label] = useState('omote')
  const [lang2Label, setLang2Label] = useState('imi')
  ...
  useEffect(() => {
    async function init() {
      ...
      if (setRes.data?.[0]) {
        ...
        setLang1Label(s.lang1_label ?? 'omote')
        setLang2Label(s.lang2_label ?? 'imi')
        ...
        <div className="bg-white rounded-2xl shadow p-6 w-full max-w-sm space-y-3">
          ...
          <div className="grid grid-cols-4 gap-2 text-center text-sm">
            <div className="bg-green-50 rounded-xl p-2">
              <p className="font-bold text-green-600">{perfect}</p>
              <p className="text-xs text-gray-400">完璧</p>
            </div>
            <div className="bg-blue-50 rounded-xl p-2">
              <p className="font-bold text-blue-600">{good}</p>
              <p className="text-xs text-gray-400">正解</p>
            </div>
            <div className="bg-yellow-50 rounded-xl p-2">
              <p className="font-bold text-yellow-600">{ok}</p>
              <p className="text-xs text-gray-400">まあまあ</p>
            </div>
            <div className="bg-red-50 rounded-xl p-2">
              <p className="font-bold text-red-600">{ng}</p>
