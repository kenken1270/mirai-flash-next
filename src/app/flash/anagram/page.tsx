...
function AnagramContent() {
  ...
  const initQuiz = (word: string) => {
    // スペルをバラバラにする（大文字小文字を維持しつつ判定は小文字で行う）
  ...
  if (cards.length === 0) return <div className="p-10 text-center">カードが見つかりません</div>
    ...
    <div className="min-h-screen bg-[#FFFDF0] flex flex-col items-center">
      ...
      <div className="flex-1 w-full max-w-md flex flex-col items-center justify-center p-6 gap-8">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-wrap gap-2 min-h-[4rem] items-center justify-center p-4 bg-white/50 rounded-2xl border-2 border-dashed border-yellow-200">
