...
const SEE_STAMPS = ${JSON.stringify(SEE_STAMPS, null, 2)}

const META_QUESTIONS = ${JSON.stringify(META_QUESTIONS, null, 2)}

const NEXT_ACTIONS = ${JSON.stringify(NEXT_ACTIONS, null, 2)}
...
console.log('✅ see/page.tsx を書き込みました！');
